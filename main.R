...
# Load order matters: rnaturalearth/rnaturalearthdata must come before sf;
# exactextractr must come before geosphere (DLL conflict on Windows/R4.5)
pacman::p_load(
    'rnaturalearth', 'rnaturalearthdata', 'exactextractr',
    'sf', 'spData', 'terra', 'cartogram',
    'geosphere',
    'ggplot2', 'ggpubr', 'tidyverse', 'dplyr', 'tidyr', 'purrr',
    'RColorBrewer', 'colorspace', 'reshape', 'ncdf4',
    'ggrepel', 'viridis', 'scico', 'scales', 'stringr', 'patchwork',
    'ggthemes', 'ggalluvial', 'svglite',
    'lfe', 'marginaleffects',
    'WDI', 'countrycode', 'rlang', 'readxl', 'tidyquant', 'here'
)
...
# Create all figure output directories (prevents interactive prompts from ggsave)
for (fig_dir in c("Figures/Main", "Figures/Main/Panels",
                  "Figures/SM", "Figures/SM/corals", "Figures/SM/ports",
                  "Figures/SM/fisheries",
                  "Figures/all_figures/corals/place_Area_Damage",
                  "Figures/all_figures/mangroves",
                  "Code/MainText_Figures_Code/figure_source_data",
                  "Results/RICE50x/analysis_output")) {
...
source("Code/Misc/color_palette.r")
source("Code/Misc/crosscutting_data.r")
#source("Code/Misc/estimating_eaths.r") #lot of hard coded Basti files 

...
# Merge future coral cover with GMST (start)
    ...
    ## Output Files (start)    
        save(corals_temp_unique,file="External_Data/output_modules/corals/corals_temp_unique.Rds")
        #write.csv(corals_temp,"External_Data/output_modules/corals/corals_temp.csv")
        #write.csv(corals_temp_unique,"External_Data/output_modules/corals/corals_temp_unique.csv")
...
## Estimate Temperature Coefficient (start)
    # Input (start)
        load(file="External_Data/output_modules/corals/corals_temp_unique.Rds")
    # Input (start)
    ...
    # Estimate GMST Coefficient (start)
        ...
        # Output (start)
            save(corals_tcoeff,file="External_Data/output_modules/corals/corals_tcoeff.Rds")
        # Output (end)
    # Estimate GMST Coefficient (end)

        load(file="External_Data/output_modules/corals/corals_tcoeff.Rds")
...
## Example of the Methodology using a subset of the data (start)
    ...
    ## Zoom in the Gulf of Mexico (start)
        ...
        save(coral_areas_gulf,file="External_Data/output_modules/corals/coral_areas_gulf.Rds")
        save(coral_temp_gulf,file="External_Data/output_modules/corals/coral_temp_gulf.Rds")
    ...
    ## Zoom in Florida Keys (start)
        ...
        save(coral_areas_keys,file="External_Data/output_modules/corals/coral_areas_keys.Rds")
        save(coral_areas_keys_single,file="External_Data/output_modules/corals/coral_areas_keys_single.Rds")
        save(coral_areas_keys_single_joined,file="External_Data/output_modules/corals/coral_areas_keys_single_joined.Rds")
        save(coral_temp_keys,file="External_Data/output_modules/corals/coral_temp_keys.Rds")
    ...
    ## Maldives
        ...
        # Save the data
        save(coral_areas_maldives, file = "External_Data/output_modules/corals/coral_areas_maldives.Rds")
        save(coral_areas_maldives_single, file = "External_Data/output_modules/corals/coral_areas_maldives_single.Rds")
        save(coral_areas_maldives_single_joined, file = "External_Data/output_modules/corals/coral_areas_maldives_single_joined.Rds")
        save(coral_temp_maldives, file = "External_Data/output_modules/corals/coral_temp_maldives.Rds")
...
## Assign coefficients to area polygons (start)
        ...
        ## Output (start)
            ...
            save(corals_area_coeff_sf,file="External_Data/output_modules/corals/corals_area_coeff_sf.Rds")
            save(corals_area_coeff_df,file="External_Data/output_modules/corals/corals_area_coeff_df.Rds")
            load("External_Data/output_modules/corals/corals_area_coeff_sf.Rds")

...
#Summarising Benefits per Ha
    ...
    # Gridcell-level mangrove projections (start)
        scen_allforcings_allES <- read.csv(file="External_Data/input_modules/mangroves/scen_allforcings_allES_ssp270.csv")
...
## Area Change
    ...
    ## Read country-level mangrove projections (start)
        ...
        diff_country_total <- read.csv(file="External_Data/input_modules/mangroves/diff_country_total_ssp370_brander_corrected_countries.csv")
        diff_country_total1 <- read.csv(file="External_Data/input_modules/mangroves/diff_country_total_ssp170_brander_corrected_countries.csv")
        diff_country_total2 <- read.csv(file="External_Data/input_modules/mangroves/diff_country_total_ssp270_brander_corrected_countries.csv")
        diff_country_total3 <- read.csv(file="External_Data/input_modules/mangroves/diff_country_total_ssp370_brander_corrected_countries.csv")
        diff_country_total4 <- read.csv(file="External_Data/input_modules/mangroves/diff_country_total_ssp470_brander_corrected_countries.csv")
        diff_country_total5 <- read.csv(file="External_Data/input_modules/mangroves/diff_country_total_ssp570_brander_corrected_countries.csv")
    ...
    ## Read Area loss (start)
        ...
        scen_arealoss_perc_both <- read.csv(file="External_Data/input_modules/mangroves/Proj_Area_Perc_onlyCC_SSP270.csv")
        grid_with_countries_ALL <- read.csv("External_Data/input_modules/mangroves/grid_with_specific_countries_FINAL.csv")

...
## Read Relative Risk increase dose-response function (start)
    ...
    #write.csv(ssp_gdp_pop_nut,"External_Data/output_modules/fish/ssp_gdp_pop_nut.csv")
...
## ALL CAUSES Read Global Burden Disease Data (start)
    ...
    gbd_deaths_number_doseresponse_pop_temp_future_dep <- read.csv("External_Data/output_modules/fish/gbd_deaths_number_doseresponse_pop_temp_future.csv")
    ...
    #write.csv(deaths_by_country_vsl,"External_Data/output_modules/fish/deaths_by_country_vsl.csv")
    #write.csv(deaths_by_country_vsl,"External_Data/input_modules/fish/nutrition/deaths_by_country_Globalvsl.csv")
    ...
    health_benefits_tcoeff <- deaths_by_country_vsl %>% filter(!is.na(health_benefits_percGDP)) %>% 
        ...
        #write.csv(health_benefits_tcoeff,"Data/output_modules_input_rice50x/input_rice50x/health_benefits_tcoeff.csv")
        #write.csv(health_benefits_tcoeff,"Data/output_modules_input_rice50x/input_rice50x/health_benefits_tcoeff_GlobalVSL.csv")
        health_benefits_tcoeff <- read.csv("Data/output_modules_input_rice50x/input_rice50x/health_benefits_tcoeff.csv")
        health_benefits_tcoeff_global <- read.csv("Data/output_modules_input_rice50x/input_rice50x/health_benefits_tcoeff_GlobalVSL.csv")
    ...
    health_tcoeff_dam <- deaths_by_country_vsl %>% filter(!is.na(health_damage_percGDP)) %>% 
        ...
        #write.csv(health_tcoeff_dam,"External_Data/output_modules/fish/health_damages_tcoeff.csv")
        write.csv(health_tcoeff_dam,"External_Data/output_modules/fish/health_damages_tcoeff_GlobalVSL.csv")

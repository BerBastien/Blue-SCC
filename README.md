...
The current repository runs on R (R-4.4.2) to calculate biophysical and economic climate damage functions for corals, mangroves, fisheries, mariculture and seaports. To run these files go to the folder code and to the subfolders of each type of capital.
